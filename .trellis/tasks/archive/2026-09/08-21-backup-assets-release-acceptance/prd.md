> **Current disposition (2026-09-17):** see [reconciliation.md](reconciliation.md) and [v0.55.16 production acceptance](research/v05516-real-data-acceptance.md). Search/preview and current container version/health pass by user report; current functional acceptance is ready for archival with explicit health-probe/log-audit limitations. Older status, backup prerequisites, delivery gates and node-log sequencing below are historical where those records supersede them.
