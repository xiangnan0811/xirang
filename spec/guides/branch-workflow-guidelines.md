...
- Specification and agent-adapter changes
...
git switch -c chore/development-guidelines
```
...
- For non-trivial work, use the native delegation and independent review boundaries in [Agent Collaboration](agent-collaboration.md). Small changes do not require a task or planning lifecycle.
