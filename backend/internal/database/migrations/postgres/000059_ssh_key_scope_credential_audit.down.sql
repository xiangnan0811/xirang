...
ALTER TABLE ssh_keys DROP COLUMN IF EXISTS allowed_node_tags;
ALTER TABLE ssh_keys DROP COLUMN IF EXISTS allowed_node_ids;
ALTER TABLE ssh_keys DROP COLUMN IF EXISTS allowed_purposes;
ALTER TABLE ssh_keys DROP COLUMN IF EXISTS expires_at;
ALTER TABLE ssh_keys DROP COLUMN IF EXISTS disabled;
