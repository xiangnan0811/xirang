-- 000014_task_deps.up.sql
-- F10: 任务依赖编排 - Task 新增前置依赖字段，TaskRun 新增链路追踪字段

ALTER TABLE tasks ADD COLUMN depends_on_task_id INTEGER REFERENCES tasks(id) ON DELETE SET NULL;

ALTER TABLE task_runs ADD COLUMN chain_run_id TEXT NOT NULL DEFAULT '';
ALTER TABLE task_runs ADD COLUMN upstream_task_run_id INTEGER REFERENCES task_runs(id) ON DELETE SET NULL;
