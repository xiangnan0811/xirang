// Package mathx holds numeric primitives shared across the backend.
//
// Kept dependency-free so any package (metrics, anomaly, slo) can depend on
...
// (xs[0], 0). Uses the standard EWMA variance update
//
