...
export const mockSSHKeys: SSHKeyRecord[] = [
  {
    ...
    username: "root",
    keyType: "rsa",
    privateKey: "FAKE_MOCK_PRIVATE_KEY_FOR_TEST_ONLY",
    fingerprint: buildFingerprint(101),
    disabled: false,
    allowedPurposes: "terminal,task_command,task_backup",
    allowedNodeIds: "",
    allowedNodeTags: "prod,critical",
    broadScope: true,
  ...
  },
  {
    ...
    disabled: false,
    expiresAt: undefined,
    allowedPurposes: "terminal,node_test,probe",
    allowedNodeIds: "",
    allowedNodeTags: "staging",
    broadScope: true,
...
export const mockPolicies: PolicyRecord[] = [
  {
    ...
    drillEnabled: true,
    drillCron: "30 3 * * *",
    drillTargetNodeId: 11,
    drillRestorePath: "/tmp/xirang-demo-drill/mysql",
    drillPreVerify: "test -d /tmp/xirang-demo-drill/mysql",
    drillVerify: "mysqlcheck --defaults-file=/tmp/xirang-demo-drill/mysql/.demo.cnf --all-databases",
    drillPostVerify: "test -f /tmp/xirang-demo-drill/mysql/xirang-demo-proof.json",
  ...
  },
  {
    ...
    drillEnabled: true,
    drillCron: "15 4 * * *",
    drillTargetNodeId: 23,
    drillRestorePath: "/tmp/xirang-demo-drill/kafka",
    drillPreVerify: "test -d /tmp/xirang-demo-drill/kafka",
    drillVerify: "test -f /tmp/xirang-demo-drill/kafka/meta.properties",
    drillPostVerify: "test -f /tmp/xirang-demo-drill/kafka/xirang-demo-proof.json",
    drillAutoCleanup: true,
    latestDrill: {
      taskRunId: 9114,
      status: "failed",
